...
var SerialPort;
if (isPi) {
    console.log("Raspberry Pi detected, using raspi-serial");
    var raspi = require('raspi');
    SerialPort = require('raspi-serial').Serial;
} else {
    console.log("Using node-serialport");
...
module.exports = function xbeeRxLibrary(options) {
    ...
    if (isPi) {
        options.serialportOptions.portId = options.serialport;
        serialport = new SerialPort(options.serialportOptions);
    } else {
